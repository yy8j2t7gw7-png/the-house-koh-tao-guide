...
Deploy and verify v5.11.2. Confirm the concise verification copy, luggage and resource guidance, then test an all-Thai exemption, a multi-passport foreign/mixed stay, the no-upload in-person passport route and a temporary spare-key code with fresh Airbnb-code revalidation and automatic team-message submission. The in-person route must stay locked until an authorized owner confirms both the passport check and the separately completed manual TM30 filing; do not automate the Immigration portal. The verified-stay secrets, Airbnb synchronizer, active listing feeds, cross-room rejection and non-sensitive passport upload are already configured or tested. A confirmed 24/7 property-emergency contact remains outstanding. Transport and other Explore modules remain deferred.
