...
Current release: v5.11.41.

The live release prioritizes the operational guest journey and AI Concierge. v5.11.41 is a narrow mobile/emergency UX correction on the already-pushed v5.11.40 human-routing release: fire/property emergencies expose **Call The House Emergency Support** without naming the configured responder, direct emergency-contact questions route deterministically, the mobile action area compacts after conversation start to give the transcript more room, and drag-to-dismiss is disabled so chat scrolling cannot move or close the sheet. v5.11.40 remains the narrow persistent-human correction for **I need to talk to a human you can not help me** during service hours. v5.11.39 remains the cleaning/state correction: natural clean up/cleanup wording enters the deterministic cleaning collector, the browser retains that collector between turns, a bare-hour follow-up such as 11 completes the same request and sends the existing service alert automatically, full page loads no longer restore invisible stale transcript history, verified guests get access-aware initial copy, vague send-request wording cannot create a context-free alert, and guest-facing copy never implies staff can reply inside the website chat. All earlier Wi-Fi, snorkeling, French Kiss Divers, lost-key, emergency-confirmation, booking, luggage, passport, Airbnb, Admin, privacy and security safeguards remain authoritative. The five newer human-friendly Meta replacement templates remain under review and are not activated here.
