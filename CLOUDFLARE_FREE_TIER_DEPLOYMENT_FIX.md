...
Wrangler plain-text vars before: 43
Wrangler plain-text vars after: 35
...
Based on the deployment logs showing 24 additional secrets/text variables, the expected total is approximately 59, below the Cloudflare Workers Free limit of 64.
