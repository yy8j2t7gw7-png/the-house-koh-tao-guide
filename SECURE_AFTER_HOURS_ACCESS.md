...
9. The guest deliberately opens the guest-friendly spare-key screen and explicitly checks the 500 THB lost-key replacement-fee confirmation before pressing **Request spare key**. This acceptance is separate from the automatic staff notification.
