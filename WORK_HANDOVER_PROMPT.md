...
Deploy and verify v5.8.2 by testing full operational translation in all seven guest languages, Bamboo social actions, the non-Thai private registration flow, owner learning review, alert-console routing and the configured Meta staff-alert channel. Then add approved stay answers as supplied. Secure guest verification, protected spare-key delivery and a confirmed 24/7 property-emergency contact remain future operational milestones. Transport and other Explore modules remain deferred.
