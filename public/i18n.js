(function () {
  ...
  const CACHE_PREFIX = "houseGuideTranslations:v5.11.13:";
  ...
  add("After-hours spare-key help", "ความช่วยเหลือเรื่องกุญแจสำรองนอกเวลาทำการ", "非工作时段备用钥匙协助", "Помощь с запасным ключом в нерабочее время", "Ersatzschlüssel-Hilfe außerhalb der Bürozeiten", "Aide pour la clé de secours hors horaires", "Ayuda con la llave de repuesto fuera de horario");
  add("If you are locked out after hours, you can request access to the spare key for your room here.", "หากคุณเข้าห้องไม่ได้ในช่วงนอกเวลาทำการ คุณสามารถขอใช้กุญแจสำรองของห้องได้ที่นี่", "如果您在非工作时段被锁在门外，可以在此申请使用客房备用钥匙。", "Если вы не можете попасть в номер в нерабочее время, здесь можно запросить доступ к запасному ключу от вашего номера.", "Wenn Sie außerhalb der Bürozeiten ausgesperrt sind, können Sie hier Zugang zum Ersatzschlüssel Ihres Zimmers anfordern.", "Si vous êtes enfermé à l’extérieur en dehors des horaires, vous pouvez demander ici l’accès à la clé de secours de votre chambre.", "Si no puedes entrar en tu habitación fuera del horario de atención, puedes solicitar aquí acceso a la llave de repuesto.");
  add("🕒 After-hours access", "🕒 การเข้าถึงนอกเวลาทำการ", "🕒 非工作时段使用", "🕒 Доступ в нерабочее время", "🕒 Zugang außerhalb der Bürozeiten", "🕒 Accès hors horaires", "🕒 Acceso fuera de horario");
  add("7:30 PM–10:30 AM Bangkok time", "19:30–10:30 น. ตามเวลาประเทศไทย", "曼谷时间晚上 7:30 至上午 10:30", "19:30–10:30 по бангкокскому времени", "19:30–10:30 Uhr (Bangkok-Zeit)", "19 h 30–10 h 30, heure de Bangkok", "19:30–10:30, hora de Bangkok");
  ...
  add("You are already verified for this room, so you do not need to enter your Airbnb confirmation code again.", "คุณได้รับการยืนยันสำหรับห้องนี้แล้ว จึงไม่ต้องกรอกรหัสยืนยัน Airbnb อีกครั้ง", "您已通过此客房的验证，无需再次输入 Airbnb 确认码。", "Вы уже подтвердили проживание в этом номере, поэтому повторно вводить код подтверждения Airbnb не нужно.", "Sie sind für dieses Zimmer bereits verifiziert und müssen Ihren Airbnb-Bestätigungscode nicht erneut eingeben.", "Votre séjour dans cette chambre est déjà vérifié ; vous n’avez donc pas besoin de saisir à nouveau votre code de confirmation Airbnb.", "Tu estancia en esta habitación ya está verificada, por lo que no necesitas volver a introducir el código de confirmación de Airbnb.");
  add("If your key has been lost, a 500 THB replacement fee applies. The House team is notified before spare-key access is released. The key-box code is not sent through WhatsApp.", "หากกุญแจสูญหาย จะมีค่าทดแทน 500 บาท ทีม The House จะได้รับแจ้งก่อนอนุญาตให้ใช้กุญแจสำรอง และจะไม่ส่งรหัสกล่องกุญแจผ่าน WhatsApp", "如果钥匙遗失，需支付 500 THB 更换费。备用钥匙开放前会通知 The House 团队。钥匙盒密码不会通过 WhatsApp 发送。", "При утере ключа взимается сбор 500 THB за замену. До предоставления доступа к запасному ключу команда The House получает уведомление. Код сейфа для ключа не отправляется через WhatsApp.", "Bei Verlust des Schlüssels fällt eine Ersatzgebühr von 500 THB an. Das Team von The House wird benachrichtigt, bevor der Zugang zum Ersatzschlüssel freigegeben wird. Der Schlüsselkasten-Code wird nicht per WhatsApp versendet.", "En cas de perte de la clé, des frais de remplacement de 500 THB s’appliquent. L’équipe de The House est avertie avant l’ouverture de l’accès à la clé de secours. Le code de la boîte à clés n’est pas envoyé par WhatsApp.", "Si has perdido la llave, se aplica una tarifa de sustitución de 500 THB. El equipo de The House recibe una notificación antes de habilitar el acceso a la llave de repuesto. El código de la caja de llaves no se envía por WhatsApp.");
  ...
  add("Your spare-key code is ready.", "รหัสกุญแจสำรองของคุณพร้อมแล้ว", "您的备用钥匙密码已准备好。", "Код запасного ключа готов.", "Ihr Ersatzschlüssel-Code ist bereit.", "Le code de votre clé de secours est prêt.", "El código de tu llave de repuesto está listo.");
