(function () {
  ...
  const CACHE_PREFIX = "houseGuideTranslations:v5.11.23:";
  ...
  add("Secure 24-hour help if you cannot enter your room.", "ความช่วยเหลืออย่างปลอดภัยตลอด 24 ชั่วโมง หากคุณไม่สามารถเข้าห้องได้", "如果您无法进入客房，可全天 24 小时安全获取协助。", "Безопасная круглосуточная помощь, если вы не можете попасть в номер.", "Sichere Hilfe rund um die Uhr, wenn Sie nicht in Ihr Zimmer kommen.", "Assistance sécurisée 24 h/24 si vous ne pouvez pas entrer dans votre chambre.", "Ayuda segura las 24 horas si no puedes entrar en tu habitación.");
  add("24-hour spare-key help", "ความช่วยเหลือเรื่องกุญแจสำรองตลอด 24 ชั่วโมง", "24 小时备用钥匙协助", "Круглосуточная помощь с запасным ключом", "Ersatzschlüssel-Hilfe rund um die Uhr", "Aide pour la clé de secours 24 h/24", "Ayuda con la llave de repuesto las 24 horas");
  ...
  add("Notifying The House team and preparing your spare-key access…", "กำลังแจ้งทีม The House และเตรียมการเข้าถึงกุญแจสำรองของคุณ…", "正在通知 The House 团队并准备您的备用钥匙使用权限…", "Уведомляем команду The House и готовим доступ к запасному ключу…", "Das Team von The House wird benachrichtigt und Ihr Ersatzschlüssel-Zugang wird vorbereitet…", "L’équipe de The House est avertie et votre accès à la clé de secours est en préparation…", "Estamos avisando al equipo de The House y preparando tu acceso a la llave de repuesto…");
  add("Thank you. Your request has been sent to The House team. You can now securely view the spare-key information below.", "ขอบคุณ คำขอของคุณถูกส่งให้ทีม The House แล้ว ตอนนี้คุณสามารถดูข้อมูลกุญแจสำรองอย่างปลอดภัยด้านล่าง", "谢谢。您的请求已发送给 The House 团队。现在您可以在下方安全查看备用钥匙信息。", "Спасибо. Ваш запрос отправлен команде The House. Теперь вы можете безопасно просмотреть информацию о запасном ключе ниже.", "Vielen Dank. Ihre Anfrage wurde an das Team von The House gesendet. Sie können die Ersatzschlüssel-Informationen jetzt unten sicher ansehen.", "Merci. Votre demande a été envoyée à l’équipe de The House. Vous pouvez maintenant consulter en toute sécurité les informations sur la clé de secours ci-dessous.", "Gracias. Tu solicitud se ha enviado al equipo de The House. Ya puedes consultar de forma segura la información de la llave de repuesto a continuación.");
  add("This lost-key request has expired. Refresh the page and explicitly accept the 500 THB fee again.", "คำขอกุญแจหายนี้หมดอายุแล้ว โปรดรีเฟรชหน้าและยอมรับค่าธรรมเนียม 500 บาทอีกครั้งอย่างชัดเจน", "此钥匙遗失请求已过期。请刷新页面并再次明确接受 500 THB 费用。", "Срок действия запроса об утере ключа истёк. Обновите страницу и снова явно подтвердите сбор 500 THB.", "Diese Anfrage wegen eines verlorenen Schlüssels ist abgelaufen. Laden Sie die Seite neu und akzeptieren Sie die Gebühr von 500 THB erneut ausdrücklich.", "Cette demande de clé perdue a expiré. Actualisez la page et acceptez à nouveau explicitement les frais de 500 THB.", "Esta solicitud por pérdida de llave ha caducado. Actualiza la página y vuelve a aceptar explícitamente la tarifa de 500 THB.");
  add("Your spare key is ready.", "กุญแจสำรองของคุณพร้อมแล้ว", "您的备用钥匙已准备好。", "Ваш запасной ключ готов.", "Ihr Ersatzschlüssel ist bereit.", "Votre clé de secours est prête.", "Tu llave de repuesto está lista.");
  add("Use the code below to open the key box next to your room door.", "ใช้รหัสด้านล่างเพื่อเปิดกล่องกุญแจข้างประตูห้องของคุณ", "请使用下方密码打开客房门旁的钥匙盒。", "Используйте указанный ниже код, чтобы открыть сейф для ключа рядом с дверью вашего номера.", "Öffnen Sie mit dem unten stehenden Code den Schlüsselkasten direkt neben Ihrer Zimmertür.", "Utilisez le code ci-dessous pour ouvrir la boîte à clés située à côté de la porte de votre chambre.", "Usa el código que aparece abajo para abrir la caja de llaves situada junto a la puerta de tu habitación.");
  add("Key-box code", "รหัสกล่องกุญแจ", "钥匙盒密码", "Код сейфа для ключа", "Schlüsselkasten-Code", "Code de la boîte à clés", "Código de la caja de llaves");
  add("Please take the spare key and close the key box again.", "โปรดนำกุญแจสำรองออกและปิดกล่องกุญแจให้เรียบร้อยอีกครั้ง", "请取出备用钥匙并重新关好钥匙盒。", "Возьмите запасной ключ и снова закройте сейф для ключа.", "Bitte nehmen Sie den Ersatzschlüssel heraus und schließen Sie den Schlüsselkasten wieder.", "Prenez la clé de secours et refermez la boîte à clés.", "Saca la llave de repuesto y vuelve a cerrar la caja de llaves.");
  add("If you need any further help, contact The House Concierge.", "หากต้องการความช่วยเหลือเพิ่มเติม โปรดติดต่อคอนเซียร์จของ The House", "如需进一步帮助，请联系 The House 礼宾服务。", "Если вам нужна дополнительная помощь, свяжитесь с консьержем The House.", "Wenn Sie weitere Hilfe benötigen, kontaktieren Sie den The House Concierge.", "Si vous avez besoin d’aide supplémentaire, contactez la conciergerie The House.", "Si necesitas más ayuda, contacta con el Concierge de The House.");
  add("A spare key has already been provided for this stay. For security, another code cannot be released automatically. Please contact The House Concierge and we will help you.", "มีการมอบกุญแจสำรองสำหรับการเข้าพักนี้แล้ว เพื่อความปลอดภัย ระบบไม่สามารถแสดงรหัสอีกครั้งโดยอัตโนมัติ โปรดติดต่อคอนเซียร์จของ The House แล้วเราจะช่วยคุณ", "本次住宿已提供过备用钥匙。出于安全考虑，系统无法自动再次提供密码。请联系 The House 礼宾服务，我们会协助您。", "Для этого проживания запасной ключ уже предоставлялся. В целях безопасности повторный код не может быть выдан автоматически. Свяжитесь с консьержем The House, и мы поможем.", "Für diesen Aufenthalt wurde bereits ein Ersatzschlüssel bereitgestellt. Aus Sicherheitsgründen kann kein weiterer Code automatisch freigegeben werden. Bitte kontaktieren Sie den The House Concierge; wir helfen Ihnen gern.", "Une clé de secours a déjà été fournie pour ce séjour. Pour des raisons de sécurité, aucun autre code ne peut être communiqué automatiquement. Contactez la conciergerie The House et nous vous aiderons.", "Ya se ha proporcionado una llave de repuesto para esta estancia. Por seguridad, no se puede mostrar otro código automáticamente. Contacta con el Concierge de The House y te ayudaremos.");
  add("Another spare-key code cannot be released until the key box has been reset. Please contact The House Concierge and we will help you.", "ไม่สามารถแสดงรหัสกุญแจสำรองอีกครั้งได้จนกว่าจะตั้งค่ากล่องกุญแจใหม่ โปรดติดต่อคอนเซียร์จของ The House แล้วเราจะช่วยคุณ", "在钥匙盒重置之前，无法再次提供备用钥匙密码。请联系 The House 礼宾服务，我们会协助您。", "Новый код запасного ключа нельзя выдать, пока сейф для ключа не будет сброшен. Свяжитесь с консьержем The House, и мы поможем.", "Ein weiterer Ersatzschlüssel-Code kann erst freigegeben werden, nachdem der Schlüsselkasten zurückgesetzt wurde. Bitte kontaktieren Sie den The House Concierge; wir helfen Ihnen gern.", "Aucun nouveau code de clé de secours ne peut être communiqué avant la réinitialisation de la boîte à clés. Contactez la conciergerie The House et nous vous aiderons.", "No se puede mostrar otro código de llave de repuesto hasta que se haya restablecido la caja de llaves. Contacta con el Concierge de The House y te ayudaremos.");
  ...
  add("Send urgent alert", "ส่งการแจ้งเตือนด่วน", "发送紧急提醒", "Отправить срочное оповещение", "Dringende Meldung senden", "Envoyer l’alerte urgente", "Enviar alerta urgente");
  add("Cancel", "ยกเลิก", "取消", "Отмена", "Abbrechen", "Annuler", "Cancelar");
  add("Urgent alert cancelled. No team message was sent.", "ยกเลิกการแจ้งเตือนด่วนแล้ว ไม่มีการส่งข้อความถึงทีม", "紧急提醒已取消。未向团队发送消息。", "Срочное оповещение отменено. Сообщение команде не отправлено.", "Die dringende Meldung wurde abgebrochen. Es wurde keine Nachricht an das Team gesendet.", "L’alerte urgente a été annulée. Aucun message n’a été envoyé à l’équipe.", "La alerta urgente se ha cancelado. No se ha enviado ningún mensaje al equipo.");
  add("Okay — I haven’t contacted The House team.", "ตกลง — ฉันยังไม่ได้ติดต่อทีม The House", "好的——我尚未联系 The House 团队。", "Хорошо — я не связывался с командой The House.", "Okay — ich habe das Team von The House nicht kontaktiert.", "D’accord — je n’ai pas contacté l’équipe de The House.", "De acuerdo: no he contactado con el equipo de The House.");
  add("Housekeeping & Service Requests", "บริการทำความสะอาดและคำขอบริการ", "客房清洁与服务请求", "Уборка и сервисные запросы", "Zimmerreinigung & Serviceanfragen", "Ménage et demandes de service", "Limpieza y solicitudes de servicio");
  add("Our regular housekeeping and service hours are Tuesday–Sunday, 10:30 AM–7:30 PM. Housekeeping is unavailable on Mondays.", "เวลาทำความสะอาดและบริการปกติคือวันอังคาร–วันอาทิตย์ เวลา 10:30–19:30 น. ไม่มีบริการทำความสะอาดในวันจันทร์", "常规客房清洁与服务时间为周二至周日上午 10:30 至晚上 7:30。周一不提供客房清洁服务。", "Обычные часы уборки и обслуживания: со вторника по воскресенье, 10:30–19:30. По понедельникам уборка недоступна.", "Die regulären Zimmerreinigungs- und Servicezeiten sind Dienstag bis Sonntag von 10:30 bis 19:30 Uhr. Montags ist keine Zimmerreinigung verfügbar.", "Les horaires habituels de ménage et de service sont du mardi au dimanche, de 10 h 30 à 19 h 30. Le ménage n’est pas disponible le lundi.", "El horario habitual de limpieza y servicio es de martes a domingo, de 10:30 a 19:30. No hay servicio de limpieza los lunes.");
  add("Please send requests for fresh towels, toilet paper, soap, room cleaning or other non-urgent items during these hours whenever possible.", "หากเป็นไปได้ กรุณาส่งคำขอผ้าเช็ดตัวสะอาด กระดาษชำระ สบู่ การทำความสะอาดห้อง หรือสิ่งของที่ไม่เร่งด่วนอื่น ๆ ในช่วงเวลาดังกล่าว", "如条件允许，请在此时段内提出更换干净毛巾、补充卫生纸或香皂、客房清洁或其他非紧急物品的请求。", "По возможности отправляйте запросы на свежие полотенца, туалетную бумагу, мыло, уборку номера и другие несрочные вещи в эти часы.", "Bitte senden Sie Anfragen nach frischen Handtüchern, Toilettenpapier, Seife, Zimmerreinigung oder anderen nicht dringenden Dingen möglichst während dieser Zeiten.", "Dans la mesure du possible, envoyez vos demandes de serviettes propres, papier toilette, savon, ménage ou autres articles non urgents pendant ces horaires.", "Siempre que sea posible, envíe durante este horario las solicitudes de toallas limpias, papel higiénico, jabón, limpieza de la habitación u otros artículos no urgentes.");
  add("After-hours requests are still recorded and will be handled from the next available housekeeping opening. A Sunday evening request will be handled from Tuesday at 10:30 AM.", "คำขอนอกเวลายังคงได้รับการบันทึกและจะดำเนินการเมื่อบริการทำความสะอาดเปิดให้บริการครั้งถัดไป คำขอในเย็นวันอาทิตย์จะดำเนินการตั้งแต่วันอังคาร เวลา 10:30 น.", "非服务时段的请求仍会被记录，并将在下一次客房清洁服务开放时处理。周日晚间的请求将从周二上午 10:30 起处理。", "Запросы вне рабочего времени по-прежнему записываются и будут обработаны с начала следующего доступного периода работы службы уборки. Запрос, отправленный в воскресенье вечером, будет обработан со вторника, 10:30.", "Anfragen außerhalb der Servicezeiten werden weiterhin erfasst und ab der nächsten verfügbaren Öffnung der Zimmerreinigung bearbeitet. Eine Anfrage am Sonntagabend wird ab Dienstag um 10:30 Uhr bearbeitet.", "Les demandes hors horaires sont toujours enregistrées et seront traitées à partir de la prochaine ouverture du service de ménage. Une demande envoyée le dimanche soir sera traitée à partir du mardi à 10 h 30.", "Las solicitudes fuera de horario se siguen registrando y se atenderán desde la siguiente apertura disponible del servicio de limpieza. Una solicitud del domingo por la noche se atenderá a partir del martes a las 10:30.");
  add("For urgent problems or emergencies, please use Help & Emergency or contact The House Concierge at any time.", "สำหรับปัญหาเร่งด่วนหรือเหตุฉุกเฉิน กรุณาใช้เมนู ความช่วยเหลือและเหตุฉุกเฉิน หรือติดต่อคอนเซียร์จของ The House ได้ทุกเวลา", "如遇紧急问题或突发情况，请使用“帮助与紧急情况”，或随时联系 The House 礼宾服务。", "При срочных проблемах или чрезвычайных ситуациях используйте раздел «Помощь и экстренные случаи» или в любое время обращайтесь к консьержу The House.", "Bei dringenden Problemen oder Notfällen nutzen Sie bitte Hilfe & Notfall oder wenden Sie sich jederzeit an den Concierge von The House.", "Pour tout problème urgent ou toute urgence, utilisez la rubrique Aide et urgence ou contactez le concierge de The House à tout moment.", "Para problemas urgentes o emergencias, use Ayuda y emergencias o contacte con el Concierge de The House en cualquier momento.");
  add("Housekeeping & service hours: Tuesday–Sunday, 10:30 AM–7:30 PM. Housekeeping is unavailable on Mondays.", "เวลาทำความสะอาดและบริการ: วันอังคาร–วันอาทิตย์ เวลา 10:30–19:30 น. ไม่มีบริการทำความสะอาดในวันจันทร์", "客房清洁与服务时间：周二至周日上午 10:30 至晚上 7:30。周一不提供客房清洁服务。", "Часы уборки и обслуживания: со вторника по воскресенье, 10:30–19:30. По понедельникам уборка недоступна.", "Zimmerreinigung & Service: Dienstag bis Sonntag, 10:30–19:30 Uhr. Montags ist keine Zimmerreinigung verfügbar.", "Ménage et service : du mardi au dimanche, de 10 h 30 à 19 h 30. Le ménage n’est pas disponible le lundi.", "Limpieza y servicio: de martes a domingo, de 10:30 a 19:30. No hay servicio de limpieza los lunes.");
  add("That looks like a local number. Please send your WhatsApp or phone number including the country code, for example +66 for Thailand.", "หมายเลขนี้ดูเหมือนเป็นหมายเลขท้องถิ่น โปรดส่งหมายเลข WhatsApp หรือโทรศัพท์พร้อมรหัสประเทศ เช่น +66 สำหรับประเทศไทย", "这似乎是本地号码。请提供包含国家代码的 WhatsApp 或电话号码，例如泰国使用 +66。", "Похоже, это местный номер. Укажите номер WhatsApp или телефона с кодом страны, например +66 для Таиланда.", "Das sieht nach einer lokalen Nummer aus. Bitte senden Sie Ihre WhatsApp- oder Telefonnummer mit Ländervorwahl, zum Beispiel +66 für Thailand.", "Ce numéro semble être au format local. Envoyez votre numéro WhatsApp ou de téléphone avec l’indicatif du pays, par exemple +66 pour la Thaïlande.", "Parece un número local. Envía tu número de WhatsApp o teléfono con el prefijo del país, por ejemplo +66 para Tailandia.");
  ...
  function addLegalFooter() {
    ...
    if (!footer.querySelector(".legal-footer-links")) {
    ...
    if (!footer.querySelector('a[href="/concierge-admin"]')) {
      const adminLink = document.createElement("a");
      adminLink.className = "admin-footer-link";
      adminLink.href = "/concierge-admin";
      adminLink.textContent = "Admin Login";
      adminLink.dataset.i18nSkip = "true";
