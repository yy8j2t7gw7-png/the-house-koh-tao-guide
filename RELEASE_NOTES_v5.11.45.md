...
- keeps **Room 7 excluded from Airbnb synchronization**;
...
- enables **Room 7** as a property/guest-guide room and Owner Admin direct-stay test room while keeping it excluded from Airbnb listing/email/iCal synchronization until a genuine Airbnb listing exists; adds the supplied Room 7 building-location photo and clearer arrival wording for Rooms 1–4 and Room 7.

Current complete automated suite: **224 passed / 0 failed**.
...
Focused/full automated suite: **224 passed / 0 failed**.
