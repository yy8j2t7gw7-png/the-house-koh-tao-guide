...
Current release: v5.11.40.

The live release prioritizes the operational guest journey and AI Concierge. v5.11.40 is a narrow human-routing correction on v5.11.39: an explicit request such as **I need to talk to a human you can not help me** now enters the deterministic persistent-human path and exposes The House team Contact Us / Call Us only during normal service hours, without naming staff. v5.11.39 is a cleaning/state correction on v5.11.38: natural clean up/cleanup wording enters the deterministic cleaning collector, the browser retains that collector between turns, a bare-hour follow-up such as 11 completes the same request and sends the existing service alert automatically, full page loads no longer restore invisible stale transcript history, verified guests get access-aware initial copy, vague send-request wording cannot create a context-free alert, and guest-facing copy never implies staff can reply inside the website chat. v5.11.38 is a narrow post-deployment wording correction on v5.11.37: persistent in-hours human/staff handoffs refer to **The House team** rather than naming Su to guests, while the Tuesday–Sunday 10:30–19:30 Bangkok service-hours gate, Monday closure and existing Contact Us / Call Us routes remain unchanged. v5.11.37 was the corrective release built directly from deployed v5.11.36 after real production testing found five production gaps: strong/direct human or housekeeper requests could miss the in-hours Su handoff; cancelled fire context could contaminate a later unrelated contact turn; natural stained-bed-sheet wording could miss the cleaning collector; French Kiss Divers preference could be ignored unless a diving workflow was already collecting; and the approved numeric Wi-Fi password could be replaced with **[number removed]** by generic model/contact sanitization. v5.11.37 makes those current turns deterministic without a broad matcher rewrite, preserves genuine fire continuation, keeps one authoritative cleaning/diving workflow, never promises provider availability, and serves authorized Wi-Fi-password questions directly from approved knowledge without weakening privacy redaction elsewhere. The v5.11.36 snorkeling correction, approved local-guide retrieval with `EXPLORE_ENABLED=false`, Bamboo priority, Mae Haad/Sairee guidance, currently active Meta action templates, universal House Maps link and every Room 11, lost-key, emergency, booking, luggage, passport, Airbnb, Admin, privacy and security safeguard remain authoritative. The five newer human-friendly Meta replacement templates remain under review and are not activated here.
