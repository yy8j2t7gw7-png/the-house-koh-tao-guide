...
Current release: v5.11.35.

The live release prioritizes the operational guest journey and AI Concierge. v5.11.35 is built directly from deployed v5.11.34. A clear current-turn local-information question now takes precedence over stale ordinary workflow context, while the pending cleaning, booking or luggage state is retained for natural resumption. The Concierge retrieves the existing approved Koh Tao activities, bars, beaches, cafés, restaurants and shopping records internally while `EXPLORE_ENABLED=false`; it gives one to three grounded choices, leads general bar/drinks recommendations with Bamboo Beach Bar and chooses a better approved fit when Bamboo is unsuitable. House knowledge states that Mae Haad Beach is about 200 metres away and Sairee Beach is roughly a 20-minute walk. Natural missing towel, toilet-paper and soap statements immediately use the existing protected Su-plus-owner service route, while supply questions remain informational. Routine page-level House calls are removed: **Contact Us** and **Book with Us** open the Concierge, and routine human contact appears only as an in-hours last resort after an AI-first attempt. Emergency and protected 24/7 lost-key actions remain separate. The five reviewed Meta staff-action templates are activated behind their exact fail-closed mappings with **Received** then **Resolve**; the buttonless service action v1 remains rejected. The existing universal House Maps link is retained after successful mobile retesting. v5.11.34's mobile-only Room 11 `72% 100%` crop and v5.11.33's stable mobile Concierge remain authoritative, with all passport, Airbnb, admin, security and operational safeguards preserved.
