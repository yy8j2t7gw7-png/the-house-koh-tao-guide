...
Deploy and verify v5.10.0, activate the prepared scheduled arrival messages, and test an all-Thai exemption, a multi-passport foreign/mixed stay and a temporary spare-key code with fresh Airbnb-code revalidation and automatic team-message submission. The verified-stay secrets, Airbnb synchronizer, active listing feeds, cross-room rejection and non-sensitive passport upload are already configured or tested. A confirmed 24/7 property-emergency contact remains outstanding. Transport and other Explore modules remain deferred.
